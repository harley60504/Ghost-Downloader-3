...
export type StateCommand =
  ...
  | { type: "popup_set_notify_on_task_created"; view: PopupView; enabled: boolean }
...
export type ActionCommand =
  ...
  | { type: "popup_set_domain_blacklist"; value: string }
  | { type: "popup_set_type_blacklist"; value: string }
  | { type: "popup_set_size_blacklist"; value: string };
